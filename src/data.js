      ...
      children: [
        {
          name: "U.S 8th Army",
          id: "98",
          description: "Korean Augmentation to the United States Army",
          ...
          children: [
            ...
            },
            {
              ...
              id: "101",
              description:
                "U.S Eigth Army Headquarters, Camp Humphreys, South Korea",
            },
            {
              name: "Awards",
              id: "102",
              description: "Army Commendation Medal, PT Master",
            },
            {
              ...
              children: [
                {
                  ...
                  id: "103",
                  description:
                    "Responsible for setting up Korean Army Intranet line for Eigth Army Headquarters, 2nd Infantry Division Headquarters,",
                },
                {
                  name: "Senior KATUSA",
                  id: "104",
                  description:
                    "Supporting supervision of 120 KATUSA soldiers in the Eighth Army Headquarters with Battalion Commander and Battalion Sergeant Major",
                },
                {
                  name: "Human Resources",
                  id: "105",
                  description:
                    "Created and maintained personnel files for 120 KATUSA soldiers in the Eighth Army Headquarters",
                },
                {
                  name: "",
                },
        ...
        },
        {
          ...
          id: "10",
          description:
            "CTO for a hotel management company in Seoul, South Korea",
          date: "2019.08 - 2022.08",
          children: [
            {
              id: "54",
              name: "Backend",
              description:
                "Created booking APIs, pricing algorithm, Kiosk API, Roomservice APIs using Node.js, Express, and MongoDB",
            },
            {
              id: "55",
              name: "Management",
              description:
                "Setup work environments and tools for the team, managed the team, and created tentative roadmaps for the company",
            },
          ],
        },
        {
              ...
              children: [
                {
                  ...
                  id: "235",
                  description:
                    "Used 3d design and 3d printing to integrate a machine vision system into portable Mouse Feeding Device. Used SLA printing to create a custom ear-tag with a April-Tag code",
                },
                {
                  name: "Data Collection",
                  id: "236",
                  description:
                    "Collected data on the feeding behavior of mice in a group setting",
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  id: "65",
                  description:
                    "Designed and built a custom 3D printed probe with Nichrome Wire Tetrals to be inserted in to the mouse brain to collect neuronal data. ",
                },
                {
                  name: "Data Collection",
                  id: "12",
                  description:
                    "Collected electrical signals of 12 mice from 4 regions of the brain using a 16 channel deep brain probe",
                },

                {
                  ...
                  id: "64",
                  description:
                    "Converted the electrical signals to a spectrogram using Short-time Fourier Transform. Created a CNN machine learning model using python, Keras and tensorflow to classify basic need's of mice such as drinking and eating based on the 16 channel neuronal data.",
                },
                {
                  name: "Conclusion",
                  id: "66",
                  description:
                    "The model was able to classify the basic needs of mice with 73% accuracy",
                },
                {
                  name: "Challenges",
                  id: "78",
                  description:
                    "We had to deal with overfitting by filtering the inputs and averaging out the input data from each region of the brain",
                },
              ],
            },
          ],
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: "W-Block",
          description:
            "Created a landing page for W-Block using React. Working on a full-stack app for blockchain transactions",
          id: "16",
